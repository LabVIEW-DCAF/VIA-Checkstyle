...
<Library LVVersion="14008000">
	...
	<Item Name="via xml report.vi" Type="VI" URL="../via xml report.vi"/>
	<Item Name="xml format - error.ctl" Type="VI" URL="../xml format - error.ctl"/>
	<Item Name="xml format - file.ctl" Type="VI" URL="../xml format - file.ctl"/>
	<Item Name="xml format.ctl" Type="VI" URL="../xml format.ctl"/>
</Library>
